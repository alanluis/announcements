<template>
    <div>
        ...
        <div class="row mb-3">
            <div class="col">
            <router-link :to="{ name: 'messages.list' }" class="btn btn-secondary mr-3">Back to Messages</router-link>
            <router-link :to="{ name: 'messages.edit', query: {id: message.id } }" class="btn btn-warning">Edit this message</router-link>
            </div>
        </div>
